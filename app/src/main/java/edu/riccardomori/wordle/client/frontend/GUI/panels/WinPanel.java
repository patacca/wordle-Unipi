...
public class WinPanel extends JPanel {
    public WinPanel(String translation, UserStats stats) {
        super();
        ...
        // Label
        JLabel label =
                new JLabel("Correct! Congratulations, you found the secret word!", JLabel.CENTER);
        this.addComponent(label, gbc, 0, 0, 0, 0, GridBagConstraints.PAGE_START, 0, 0, 1, 1);

        // Label
        JLabel label2 = new JLabel(String.format("The italian translation is `%s`", translation),
                JLabel.CENTER);
        this.addComponent(label2, gbc, 0, 1, 0, 1, GridBagConstraints.PAGE_START, 0, 0, 1, 1);

        // Stats Panel
        JPanel statsPanel = new StatsPanel(stats);
        gbc.fill = GridBagConstraints.BOTH;
        this.addComponent(statsPanel, gbc, 0, 2, 1, 1, GridBagConstraints.CENTER, 0, 0, 1, 1);
    }
